...
ORO_LIST_COMPONENT_TYPE( arp_stm32::PumpManager)

PumpManager::PumpManager(const std::string& name) :
...
bool PumpManager::configureHook()
{
...
void PumpManager::createOrocosInterface()
{
    addAttribute("attrStm32Time", m_robotItf.current_time);
}

void PumpManager::createRosInterface()
{
    ros::NodeHandle nh;
}
