...
#         sis = smach_ros.IntrospectionServer('strat_server', sm, '/StratNode_Homologation')
#         sis.start()
        sm.execute()
#         
#         sis.stop()
