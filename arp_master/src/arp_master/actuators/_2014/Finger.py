...
class AmbiFingerPickObject(smach.StateMachine):
    def __init__(self, p_side):
            smach.StateMachine.__init__(self,outcomes=['picked','blocked','notFound'])
            ...
            with self:      
                ...
                smach.StateMachine.add('SearchItemToPick',
                       AmbiWaitFingerOmronValue(p_side, "Fire", True, 10.0),
                ...
                smach.StateMachine.add('SuckMyLovingPump',
                       FingerPumpCommand(p_side, Robot2014.suctionPower['HOLD']),
                ...
                smach.StateMachine.add('WaitForObjectPresent',
                       FingerWaitForObjectPresent(p_side, 5.0),
                ...
                smach.StateMachine.add('CheckPresence',
                       ...
                       transitions={'object_present':'picked', 'timeout':'notFound'})
...
class FingerWaitForObjectPresent(ReceiveFromTopic):
    def __init__(self, p_side, p_timeout):
        ReceiveFromTopic.__init__(self, "/Ubiquity/"+p_side+"FingerPump/object_present", Bool,
                                  p_outcomes=['object_present'], p_timeout=p_timeout) 
...
class AmbiWaitFingerOmronValue(AmbiWaitForOmronValue):
    def __init__(self, p_side, p_name, p_awaitedValue, p_timeout):
        AmbiWaitForOmronValue.__init__(self, AmbiOmron(p_side, "Finger" + p_name + "Omron"), p_awaitedValue, p_timeout) 
