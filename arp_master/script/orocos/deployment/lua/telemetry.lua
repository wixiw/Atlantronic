...
function Telemetry:reportRobotState()
    ...
    Reporting:reportPort("Localizator","outDEBUGdate1")
    Reporting:reportPort("Localizator","outDEBUGXtarget1")
    Reporting:reportPort("Localizator","outDEBUGYtarget1")
    Reporting:reportPort("Localizator","outDEBUGRangeMeas1")
    Reporting:reportPort("Localizator","outDEBUGThetaMeas1")
    Reporting:reportPort("Localizator","outDEBUGdate2")
    Reporting:reportPort("Localizator","outDEBUGXtarget2")
    Reporting:reportPort("Localizator","outDEBUGYtarget2")
    Reporting:reportPort("Localizator","outDEBUGRangeMeas2")
    Reporting:reportPort("Localizator","outDEBUGThetaMeas2")
    Reporting:reportPort("Localizator","outDEBUGdate3")
    Reporting:reportPort("Localizator","outDEBUGXtarget3")
    Reporting:reportPort("Localizator","outDEBUGYtarget3")
    Reporting:reportPort("Localizator","outDEBUGRangeMeas3")
    Reporting:reportPort("Localizator","outDEBUGThetaMeas3")
...
function Telemetry:reportOmnidirect()
	...
	Reporting:reportPort("MotionControl","outDEBUGMode")
