  ...
  using namespace RTT;
    // Factory function
        ...
        void rtt_ros_addType_Odo() {
             ...
             RTT::types::Types()->addType( new types::StructTypeInfo<arp_core::Odo>("/arp_core/Odo") );
             RTT::types::Types()->addType( new types::PrimitiveSequenceTypeInfo<std::vector<arp_core::Odo> >("/arp_core/Odo[]") );
             RTT::types::Types()->addType( new types::CArrayTypeInfo<RTT::types::carray<arp_core::Odo> >("/arp_core/cOdo[]") );
        }
