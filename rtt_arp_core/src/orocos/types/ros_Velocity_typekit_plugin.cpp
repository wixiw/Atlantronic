  ...
  using namespace RTT;
    // Factory function
        ...
        void rtt_ros_addType_Velocity() {
             ...
             RTT::types::Types()->addType( new types::StructTypeInfo<arp_core::Velocity>("/arp_core/Velocity") );
             RTT::types::Types()->addType( new types::PrimitiveSequenceTypeInfo<std::vector<arp_core::Velocity> >("/arp_core/Velocity[]") );
             RTT::types::Types()->addType( new types::CArrayTypeInfo<RTT::types::carray<arp_core::Velocity> >("/arp_core/cVelocity[]") );
        }
