  ...
  using namespace RTT;
    // Factory function
        ...
        void rtt_ros_addType_OmniOdo() {
             ...
             RTT::types::Types()->addType( new types::StructTypeInfo<arp_core::OmniOdo>("/arp_core/OmniOdo") );
             RTT::types::Types()->addType( new types::PrimitiveSequenceTypeInfo<std::vector<arp_core::OmniOdo> >("/arp_core/OmniOdo[]") );
             RTT::types::Types()->addType( new types::CArrayTypeInfo<RTT::types::carray<arp_core::OmniOdo> >("/arp_core/cOmniOdo[]") );
        }
