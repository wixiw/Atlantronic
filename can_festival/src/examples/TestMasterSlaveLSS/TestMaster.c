...
TIMER_HANDLE TestMaster_heartBeatTimers[2] = {TIMER_NONE,TIMER_NONE};
...
/* index 0x1016 :   Consumer Heartbeat Time. */
                    UNS8 TestMaster_highestSubIndex_obj1016 = 2; /* number of subindex - 1*/
...
/* index 0x1F22 :   Concise DCF. */
                    UNS8 TestMaster_highestSubIndex_obj1F22 = 3; /* number of subindex - 1*/
                    INTEGER8* TestMaster_obj1F22[] = 
                    {
                      "",
                      "\x01\x00\x00\x00\x17\x10\x00\x02\x00\x00\x00\x00\x00",
                      "\x01\x00\x00\x00\x17\x10\x00\x02\x00\x00\x00\x00\x00"
                    };
                    subindex TestMaster_Index1F22[] = 
                     {
                       ...
                       { RW, domain, 13, (void*)&TestMaster_obj1F22[2] }
                     };
...
/* index 0x2002 :   Mapped variable MasterMap3 */
                    subindex TestMaster_Index2002[] = 
                     {
                       { RW, uint16, sizeof (UNS16), (void*)&MasterMap3 }
                     };
