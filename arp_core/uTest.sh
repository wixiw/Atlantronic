...
./uTest_Core_Filters.ard  --output_format=XML --log_level=all --report_level=no > $TEST_OUTPUT_DIR/uTest_Core_Filters.xml
./uTest_Core_Models.ard  --output_format=XML --log_level=all --report_level=no > $TEST_OUTPUT_DIR/uTest_Core_Models.xml
