...
public:
  ...
  inline HPButterworthFilter (const double samplingPeriod, const double cutoffFrequency);
  inline ~HPButterworthFilter ();
...
HPButterworthFilter::HPButterworthFilter (const double samplingPeriod, const double cutoffFrequency)
{
...
HPButterworthFilter::~HPButterworthFilter ()
{
  ;
}

void HPButterworthFilter::updateCacheValues ()
{
...
void HPButterworthFilter::setParameters (const double samplingPeriod, const double cutoffFrequency)
{
...
void HPButterworthFilter::initialize (const Eigen::Displacementd& Y0)
{
  U[0] = Y0;
  U[1] = Y0;
...
bool HPButterworthFilter::isInitialized () const
{
  return initDone;
}

void HPButterworthFilter::reset ()
{
  initDone = false;
  cacheValues_areUpToDate = false;
}

double HPButterworthFilter::getSamplingPeriod () const
{
  return this->samplingPeriod;
}

double HPButterworthFilter::getCutOffFrequency () const
{
  return this->cutoffFrequency;
}

void HPButterworthFilter::computePositionAndVelocity (const Eigen::Displacementd& Uk,
                                                      Eigen::Displacementd& Yk, 
                                                      Eigen::Twistd& Tk)
{
  updateCacheValues ();
  ...
  //*****************************************************************************************
  // Angular velocity
  Eigen::Rotation3d tmpRot = Y[0].getRotation ().inverse() * Yk.getRotation();
  Tk.getAngularVelocity() =  tmpRot.log() * samplingFrequency;
