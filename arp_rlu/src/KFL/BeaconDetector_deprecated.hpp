/*
 * BeaconDetector_deprecated_deprecated.hpp
 *
 *  Created on: 22 January 2012
 *      Author: Boris
 */

#ifndef _ARP_RLU_KFL_BEACONDETECTOR_DEPRECATED_HPP_
#define _ARP_RLU_KFL_BEACONDETECTOR_DEPRECATED_HPP_
...
/** \ingroup kfl
 *
 * \class BeaconDetector_deprecated
 *
 * \brief BeaconDetector_deprecated est la classe qui concentre les traitements de scan pour KFL.
 *
 * C'est cette classe qui utilise BFL pour extraire la mesure des balises.
 *
 *  Le cycle de vie standard est :
 *  -# construction du BeaconDetector_deprecated
 ...
 *  -# destruction du BeaconDetector_deprecated
 */
class BeaconDetector_deprecated
{
    public:
         ...
         * \class Params
         *
         * \brief BeaconDetector_deprecated::Params rassemble les paramètres du traitement de scan.
         *
         */
        class Params
        {
    ...
    public:
         ...
         * \param[in] paramètres sous la forme d'un kfl::BeaconDetector_deprecated::Params
         */
        void setParams(kfl::BeaconDetector_deprecated::Params);
    ...
    protected:
        ...
        /**
         * Paramètres du BeaconDetector_deprecated
         */
...
#endif /* _ARP_RLU_KFL_BEACONDETECTOR_DEPRECATED_HPP_ */
