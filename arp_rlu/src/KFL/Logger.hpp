...
#ifndef _ARP_RLU_KFL_LOGGER_HPP_
#define _ARP_RLU_KFL_LOGGER_HPP_
...
class Logger
{
    public:
         ...
         */
        static void InitNull(const std::string n = "KFL", arp_core::log::Priority::Value loglevel = arp_core::log::INFO);

        /** InitConsole initialise le Logger pour qu'il publie dans la sortie standard de la console.
         * \param n est le nom de la catégorie
         * \param loglevel est le niveau de priorité minimal
         */
        static void InitConsole(const std::string n = "KFL", arp_core::log::Priority::Value loglevel = arp_core::log::INFO);
         ...
         */
        static void InitFile(const std::string n = "KFL", arp_core::log::Priority::Value loglevel = arp_core::log::DEBUG);
