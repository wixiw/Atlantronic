/*
 * DuoCircleIdentif.hpp
 *
 *  Created on: 23 Mars 2012
 *      Author: Boris
 */

#ifndef _ARP_RLU_LSL_DUOCIRCLEIDENTIF_HPP_
#define _ARP_RLU_LSL_DUOCIRCLEIDENTIF_HPP_
...
/** \class DuoCircleIdentif
 *
 * \brief DuoCircleIdentif permet d'identifier des DetectedCircle parmi des Circle référencés.
 *
...
class DuoCircleIdentif
{
    public:
         ...
         * \class Params
         *
         * \brief DuoCircleIdentif::Params rassemble les paramètres du filtre DuoCircleIdentif.
         *
         */
        class Params : ParamsInterface
        {
            ...
            /**
             * Tolerance sur la longueur du segment entre les deux DetectedCircle par rapport à celle du semgent entre les deux Circle de référence.
             */
    ...
    public:
         ...
         * \param[in] vprcrc vecteur de paires de Circle de référence
         * \param[in] p paramètres du filtre
         * \return le vecteur des appariements trouvés
         */
        static std::vector< std::pair< std::pair<DetectedCircle, DetectedCircle>, std::pair<Circle,Circle> > > apply(const std::vector<DetectedCircle> & vdc, const std::vector< std::pair<Circle,Circle> > & vprcrc, const Params & p = Params());
...
#endif /* _ARP_RLU_LSL_DUOCIRCLEIDENTIF_HPP_ */
